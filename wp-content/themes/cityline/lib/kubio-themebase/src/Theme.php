...
class Theme extends ThemeBase {
	...
	public function enqueueThemeInfoPageScripts() {
		...
		if ( $this->shouldDisplayAdminNotice() ) {
			...
			<script>
				jQuery(function ($) {
					$(".cityline-admin-big-notice").show();
				});
			</script>
			<?php
	...
	public function addThemeNotice() {
		if ( $this->shouldDisplayAdminNotice() ) :
			?>
			<div class="notice notice-success is-dismissible cityline-admin-big-notice notice-large">
		...
		<div class="kubio-onboarding kubio-step-1--active">
			<div>
					...
					<div class="kubio-onboarding__wrapper__content">
						<label>
							...
							<div class="radio-card">
								<div class="radio-card__radio-checked">
									<?php echo file_get_contents( cityline_theme()->getThemeResource( 'images/theme-base/check.svg' ) ); ?>
									<div class="radio-card__radio-checked__background"></div>
								</div>
								<div class="radio-card__image-container">
									<img src="<?php echo cityline_theme()->getThemeResource( 'images/theme-base/web-layout.png' ); ?>"
						...
						<label>
							...
							<div class="radio-card">
								...
								<div class="radio-card__image-container">
									<img src="<?php echo cityline_theme()->getThemeResource( 'images/theme-base/blog-layout.png' ); ?>"
				...
				<div class="kubio-onboarding__wrapper kubio-step-2">
					...
					<div class="kubio-onboarding__wrapper__content">
						<p><?php Translations::escHtmlE( 'theme_description', cityline_theme()->getName() ); ?></p>

						<ul>
							<li>
								<?php echo file_get_contents( cityline_theme()->getThemeResource( 'images/theme-base/round-check.svg' ) ); ?>
