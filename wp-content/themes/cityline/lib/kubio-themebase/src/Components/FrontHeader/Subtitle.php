		...
		return array(
			...
			'settings' => array(
				...
				"{$prefix}localProps.content" => array(
					'default' =>  __( 'Morbi egestas id est vel elementum. In ultrices viverra est sed blandit. Aenean posuere orci magna, sit amet rutrum nulla euismod sed.', 'cityline' ),
					'control' => array(
