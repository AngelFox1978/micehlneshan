...
Cityline is an innovative,  easily customizable, multi-purpose theme, focused on empowering users to build astonishing WordPress websites. Cityline is mainly designed for small businesses, startups, or personal portfolio websites and works perfectly with Kubio Page Builder which enriches the WordPress block editor with a variety of new blocks and advanced styling options to give you full design freedom.

== Frequently Asked Questions ==

= How can I customize Cityline? =

    To customize the Cityline theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Cityline WordPress theme, Copyright (C) 2024 ExtendThemes
Cityline WordPress theme is licensed under the GPL3.
...
- Images
  ...
  These assets are distributed under the CC0 License:
        ...
        Source: https://stocksnap.io/photo/buildings-skyline-EFMLJD0R2I
