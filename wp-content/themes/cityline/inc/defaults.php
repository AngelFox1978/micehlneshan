<?php
$cityline_theme_svg_icons = array(
	'fort-awesome'         => array(
...
$cityline_theme_divider_style = array(
...
$cityline_title                         = 'creative&nbsp;<br><span style="color:rgba(var(--kubio-color-1),1)" class="kubio-has-inline-color">design</span> agency';
$cityline_subtitle                      = 'Morbi egestas id est vel elementum. In ultrices viverra est sed blandit. Aenean posuere orci magna, sit amet rutrum nulla euismod sed.';
$cityline_theme_action_button           = 'Start today';
$cityline_theme_action_button_secondary = 'Contact us';

$defaults = array(
	'default_icon'                      => $cityline_theme_svg_icons['fort-awesome'],
	'icons'                             => $cityline_theme_svg_icons,
	'divider_style'                     => $cityline_theme_divider_style,
	'gradients'                         => $cityline_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $cityline_title,
	'lorem_ipsum'                       => $cityline_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $cityline_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $cityline_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'       => true,
			'value'      => $cityline_title,
			'localProps' => array(
				'content' => $cityline_title,
			),
			'style'      => array(
				'descendants' => array(
					'text' => array(
		...
		'subtitle'     => array(
			'show'       => true,
			'value'      => $cityline_subtitle,
			'localProps' => array(
				'content' => $cityline_subtitle,
			),
			'style'      => array(
				'descendants' => array(
					'text' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $cityline_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cityline_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cityline_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $cityline_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cityline_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $cityline_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgba(163,192,206,1)',
