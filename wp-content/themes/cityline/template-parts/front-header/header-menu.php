									...
									<div class="position-relative wp-block-kubio-column__inner cityline-front-header__k__dySu33XviAE-inner cityline-local-123-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-2 h-px-md-2 v-inner-md-2 h-px-2 v-inner-2">
										...
										<div class="position-relative wp-block-kubio-column__align cityline-front-header__k__dySu33XviAE-align cityline-local-123-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
											...
											cityline_theme()->get( 'logo' )->render(
												array(
													'wrapper_class'        => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row cityline-front-header__k__afIZ7lcsb-container cityline-local--container',
													'logo_image_class'     => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  cityline-front-header__k__afIZ7lcsb-image cityline-local--image',
													'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   cityline-front-header__k__afIZ7lcsb-alternateImage cityline-local--alternateImage',
													'logo_text_class'      => 'position-relative wp-block-kubio-logo__text  cityline-front-header__k__afIZ7lcsb-text cityline-local--text',
												)
											);
											?>
										</div>
